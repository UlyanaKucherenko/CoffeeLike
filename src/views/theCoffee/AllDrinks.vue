<template>
    <div class="all-drinks">
        <div class="all-drinks__wrap-btn">
                <router-link to="/coffee">
                    <the-button class="coffee__btn" icon="arrow-left" type="secondary"></the-button>
                </router-link>
            </div>
        <a-input-search placeholder="input search text" style="width: 200px" />       
<!--
            <div class="all-drinks__products">
                    <div class="all-drinks__product" v-for="item of coffee" :key="item.name">
                         <a-card hoverable style="max-width: 200px" @click="showModal" >
